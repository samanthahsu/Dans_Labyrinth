...
public class Brick extends Feature {
    ...
    private static final String Q3 = "The sum of the codes of the letters in the"
            + " words \"BIG BANG\" using the encoding A=1, B=2, C=3, etc.";
    ...
    private static final String Q5 = "The number of museums in Amsterdam\n(DYK: "
            + "Netherlands has the highest concentration of museums in the world).";
    private static final String Q6 = "The number of spots (or pips, circular"
            + " patches or pits) on a pair of standard six-sided dice.";
    private static final String TRIVIA_42 =
            "https://numbersapi.p.rapidapi.com/42/trivia?fragment=true&notfound=floor&json=false.";
